...
def interference(distance, angle, wavelength):
    """
    Calculates interference term within intensity function
...
def diffraction(slit_width, angle, wavelength):
    """
    Calculates diffraction term within intensity function
    :param slit_width: width of each slit in µm (10^-6)
    :param angle: angles over which the light will travel in radians
    :param wavelength: wavelength of the incoming light in nm (10^9)
...
def intensity_pattern(distance, wavelength, slit_width):
    """
    Computes intensity of the light pattern emerging on the screen
    :param distance:
    :param wavelength:
    :param slit_width:
    :return:
    """
    interference_factor = interference(distance, theta, wavelength)
    diffraction_factor = diffraction(slit_width, theta, wavelength)
    intensity = interference_factor * diffraction_factor
    return intensity
...
def sliders_on_changed(val):
    """
    Modifies the line when slider's value changes
    :param val:
    :return:
    """
